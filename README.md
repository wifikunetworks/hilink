...
```
bash -c "$(wget -qO - 'https://raw.githubusercontent.com/wifikunetworks/hilink/master/setup.sh')"
```
...
- HG680P<br>
  copy paste di terminal script berikut<br>
  ```
  rm -f /usr/bin/hgled && wget -O /usr/bin/hgled https://raw.githubusercontent.com/wifikunetworks/hilink/main/bled-hgled/hgled && chmod +x /usr/bin/hgled && /usr/bin/hgled -r
  ```
<br><br>
2. CARA 2<br>
